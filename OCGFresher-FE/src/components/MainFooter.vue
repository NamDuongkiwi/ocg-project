  ...
  <footer class="bg6 p-t-45 p-b-45 p-l-45 p-r-45">
    <div class="flex-w">
      <div class="w-size6 p-t-30 p-l-15 p-r-15 respon3">
        <h4 class="s-text12 p-b-30">Địa chỉ liên hệ</h4>

        <div>
          <p class="s-text7 w-size27">
            Tầng 12, Toà nhà Kiwi Town, số 1024 đường Xuân Thuỷ, quận Cầu Giấy, Hà Nội
            , CSKH: 19001024
          </p>
      ...
      <div class="w-size7 p-t-30 p-l-15 p-r-15 respon4">
        <h4 class="s-text12 p-b-30">Danh mục sản phẩm</h4>

        <ul>
          <li class="p-b-9">
            <a href="#" class="s-text7"> Linh kiện PC </a>
          </li>

          <li class="p-b-9">
            <a href="#" class="s-text7"> Phụ kiện </a>
          </li>

          <li class="p-b-9">
            <a href="#" class="s-text7"> Gaming Gear </a>
          </li>

          <li class="p-b-9">
            <a href="#" class="s-text7">  </a>
          </li>
        </ul>
      </div>
